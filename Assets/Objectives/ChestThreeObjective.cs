...
public class ChestThreeObjective : MonoBehaviour
{
    public Transform player; // Player's transform
    public Transform Level3Chest; //  chest 3 GameObject
    ...
    void Update()
    {
        ...
        float distance = Vector3.Distance(player.position, Level3Chest.position);
